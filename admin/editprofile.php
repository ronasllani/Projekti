    ...
    <body>
        ...
        <main class="loginmain">
            <div class="container">
                ...
                <form class="register forms form-style" id="mainForm" method="post" action="editprofile.php?ID=<?php echo $UserID ?>">
                    ...
                    <input id="submit" type="submit" class="inputs submit" value="Edit" name="edit_btn"/>
                </form>
            </div>
        </main>
        <footer>
